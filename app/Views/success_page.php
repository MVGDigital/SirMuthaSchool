...
<?php if (isset($registration_number)): ?>
    <h3 style="text-align:center;">Applied for kindergarten to grade IX : 2025-2026</h3> 
    <h4 style="text-align:center;margin-top:30px;">
        ...
        <br><br>
        Please <a target="_blank" style="color:#2A3F92;" href="<?php echo base_url('admission/printView/' . $registration_number); ?>">click here</a> to print the application.
    </h4>
<?php else: ?>
