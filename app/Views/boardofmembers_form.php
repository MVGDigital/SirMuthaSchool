        ...
        <div class="row">
            <div class="col-6">
                <div class="formFields row w100 m-0">
                    ...
                    <div class="mb-3 row">
                        <label for="boardofmembers-photo" class="col-sm-4 col-form-label">Photo</label>
                        <div class="col-sm-8">
                            <input class="form-control" type="file" id="boardofmembers-photo"
                                name="boardofmembers_photo" accept="image/*">
                    ...
                    <div class="mb-3 row">
                        <label for="boardofmembers-name" class="col-sm-4 col-form-label">Name</label>
                        <div class="col-sm-8">
                            <input class="form-control" type="text" id="boardofmembers-name" name="name"
                    ...
                    <!-- Designation -->
                    <div class="mb-3 row">
                        <label for="boardofmembers-designation" class="col-sm-4 col-form-label">Designation</label>
                        <div class="col-sm-8">
                            <input class="form-control" type="text" id="boardofmembers-designation" name="designation"
                    ...
                    <!-- Content -->
                    <div class="mb-3 row">
                        <label for="boardofmembers-content" class="col-sm-4 col-form-label">Content</label>
                        <div class="col-sm-8">
