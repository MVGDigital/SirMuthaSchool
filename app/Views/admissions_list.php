...
<head>
    ...
    <style>
        ...
        .dt-button:hover {
            background-color:rgb(1, 36, 118)!important; /* Darker shade on hover */
                                    ...
                                    <table id="admissionsTable" class="display nowrap" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo esc($admission['registration_number']); ?></td>
                                                <td><?php echo esc($admission['name']); ?></td>
                                                <td><?php echo esc(date('d-M-Y', strtotime($admission['dob']))); ?></td>
                                                <td><?php echo esc($admission['gender']); ?></td>
                                                <td><?php echo esc($admission['nationality']); ?></td>
                                                <td><?php echo esc($admission['state']); ?></td>
            ...
            $('#admissionsTable').DataTable({
                ...
                buttons: [{
                    ...
                    action: function(e, dt, button, config) {
                        ...
                        // Add headers
                        ws_data.push(['S.No', 'Registration Number', 'Name',
                            'Date of Birth', 'Gender', 'Nationality', 'State',
                            'Religion', 'Community', 'Mother Tongue', 'Caste',
                            'Class Last Studied', 'School Last Attended',
                            'Class Admission Sought', 'Residential Address',
                            'Father Name', 'Father Religion', 'Father Language',
                            'Father Qualification', 'Father Occupation',
                            'Father Mobile', 'Father Email', 'Mother Name',
                            'Mother Religion', 'Mother Language',
                            'Mother Qualification', 'Mother Occupation',
                            'Mother Mobile', 'Mother Email', 'Guardian Name',
                            'Guardian Relation', 'Guardian Occupation',
                            'Guardian Mobile', 'Guardian Email', 'Guardian Address',
                            'Sibling Name', 'Other Info'
                        ]);
                        ...
                        ws_data.push([
                            ...
                            '<?php echo esc($admission['name']); ?>', // Name
                            ...
                            '<?php echo esc($admission['mother_tongue']); ?>', // Mother Tongue
                            '<?php echo esc($admission['caste']); ?>', // Caste
                            '<?php echo esc($admission['class_last_studied']); ?>', // Class Last Studied
                            '<?php echo esc($admission['school_last_attended']); ?>', // School Last Attended
                            '<?php echo esc($admission['class_admission_sought']); ?>', // Class Admission Sought
