                ...
                <ul class="splide__list">
                        ...
                        <div class="row m-0 w100">
                            <div class="col-12 col-md-6 col-lg-6 col-xl-6 p-0">
                                <div class="cardWith-under-info">
                                    <img src="<?= base_url('images/facilities/Heritage club.png') ?>"
                            ...
                            <div class="col-12 col-md-6 col-lg-6 col-xl-6 p-0">
                                <div class="cardWith-under-info">
                                    <img src="<?= base_url('images/facilities/Maths club.png') ?>"
                                        class="img-fluid" alt="Sir Mutha Logo">
                                    <div class="sectionSubTitle-white">
                    ...
                    <li class="splide__slide">
                        <div class="row m-0 w100">
                            <div class="col-12 col-md-6 col-lg-6 col-xl-6 p-0">
                                <div class="cardWith-under-info">
                                    <img src="<?= base_url('images/facilities/Eco club.png') ?>"
                                        class="img-fluid" alt="Sir Mutha Logo">
                                    <div class="sectionSubTitle-white">
                            ...
                            <div class="col-12 col-md-6 col-lg-6 col-xl-6 p-0">
                                <div class="cardWith-under-info">
                                    <img src="<?= base_url('images/facilities/Interact club.png') ?>"
                                        class="img-fluid" alt="Sir Mutha Logo">
                                    <div class="sectionSubTitle-white">
                            ...
                            <div class="thumbContent">
                                ...
                                <div class="whiteBtn-medium">
                                    <!-- <a
                                        ...
                                        <a
                                        href="https://sirmuthaschool.mvgdigital.com/public/images/news-letter2.pdf"  target="_blank">Know
                                        More</a>
                                </div>
                            </div>
                        </div>
                        <div class="slick-slider-banner-image">
                            <img src="<?= base_url('images/beyond-curriculum/newsletterbannerimg2.jpg') ?>" class="img-fluid"
                                alt="Sir Mutha Newsletter Image">
                            <div class="thumbContent">
                                ...
                                <div class="whiteBtn-medium">
                                    <a
                                        href="https://sirmuthaschool.mvgdigital.com/public/images/news-letter1.pdf"  target="_blank">Know
                                        More</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="slider slider-nav thumb-image">
                        <div class="thumbnail-image">
                            ...
                            <div class="thumbContent">
                                ...
                                <span>Dec, 2024</span>
                                <div class="whiteBtn-medium">
                                    <a href="https://sirmuthaschool.mvgdigital.com/public/images/news-letter2.pdf">Know More</a>
                                </div>
                            </div>
                        </div>
                        <div class="thumbnail-image">
                            ...
                            <div class="thumbContent">
                                ...
                                <span>August, 2017</span>
                                <div class="whiteBtn-medium">
                                    <a href="https://sirmuthaschool.mvgdigital.com/public/images/news-letter1.pdf">Know More</a>
                                </div>
                            </div>
                        </div>
                        <div class="thumbnail-image">
                                ...
                                <ul class="splide__list">
                                    ...
                                    <li class="splide__slide">
                                     ...
                                     <li class="splide__slide">
                                        ...
                                        <div class="thumbContent">
                                            <h6>7th Dec 2024</h6>
                                            <p>The ‘Open House’ for Kindergarten to Class XI was held on Saturday, 7th December 2024, offering parents valuable insights into their children’s progress. The event coincided with the Christmas Fair 2024, which transformed the campus into a vibrant carnival. Featuring a variety of stalls, games, and activities, the fair created a festive and lively atmosphere. Students, parents, and staff enthusiastically participated in the celebrations, making it a day to cherish. </p>
                                            <div class="whiteBtn-medium">
                                                <a href="#">View Gallery</a>
                                            </div>
                                        </div>
                                     ...
                                     <li class="splide__slide">
                                        ...
                                        <div class="thumbContent">
                                            <h6>10th Dec 2024</h6>
                                            <p>The Investiture Ceremony for the new office bearers of 2025-26 was in the presence of the Chief Guest, Ms. Dia Rekhi, an alumna of Lady Andal Venkatasubba Rao School. In a moment of solemnity, the new office bearers took their oath, vowing to uphold their duties with steadfast integrity and commitment. The occasion also featured a heartfelt prayer service for the students of Classes X and XII, as they stand on the cusp of their public examinations. The event was a beautiful convergence of leadership, faith, and encouragement, reaffirming the values of responsibility and resilience. </p>
                                            <div class="whiteBtn-medium">
                                                <a href="#">View Gallery</a>
                                            </div>
                                        </div>
                            ...
                            <div class="splide__track">
                                <ul class="splide__list">
                                    ...
                                    <li class="splide__slide">
                                        ...
                                        <div class="thumbContent">
                                            <h6>25th Oct 2024</h6>
                                            <p>A Road Safety Training Session was conducted for children who were part of the RSP unit of Sir Mutha School, from Classes VII to X, by Mr. Vivek. The session focused on essential traffic rules and hand signals, with students actively practising and demonstrating these skills. Mr Vivek’s engaging presentation highlighted the importance of responsible road behaviour. The session was well-received, leaving a lasting impact on the young participants.</p>
                                            <div class="whiteBtn-medium">
                                                <a href="#">View Gallery</a>
                                            </div>
                                        </div>
                                ...
                                <ul class="splide__list">
                                    ...
                                    <li class="splide__slide">
                                        ...
                                        <div class="thumbContent">
                                            ...
                                            <p>The Scholastic Book Fair was a celebrated event, offering an extensive collection of books designed to ignite the imaginations of students and nurture their enthusiasm for reading. The fair presented a diverse selection across various genres, appealing to a wide range of interests and age groups. Students perused the books with keen interest, eager to discover their next literary adventure.</p>
                                            <div class="whiteBtn-medium">
                                                <a href="#">View Gallery</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="thumbContent">
                                            ...
                                            <p>A Parent-Teacher Meeting was convened to review students’ progress and address any concerns. Parents and teachers engaged in meaningful discussions, exchanging feedback and insights to support the holistic development of each child. It served to reinforce the vital partnership between home and school, aimed at ensuring the continued success of every student.</p>
                                            <div class="whiteBtn-medium">
                                                <a href="#">View Gallery</a>
                                            </div>
                                        </div>
                                  ...
                                  <li class="splide__slide">
                                     ...
                                     <li class="splide__slide">
                                        ...
                                        <div class="thumbContent">
                                            ...
                                            <p>The Eco Club organised a sapling planting activity for students of Classes XI and XII to encourage environmental responsibility and emphasise the value of green spaces. The activity aimed to deepen students’ connection with nature and highlight the vital role of trees in sustaining the ecosystem. Students participated with palpable enthusiasm, revelling in the fulfilment of contributing to the vision of a sustainable and verdant future. </p>
                                            <div class="whiteBtn-medium">
                                                <a href="#">View Gallery</a>
                                            </div>
                                        </div>
                                     ...
                                     <li class="splide__slide">
                                        ...
                                        <div class="thumbContent">
                                            ...
                                            <p>Class III students enjoyed a fun-filled Bagless Day with a variety of activities. They wrote recipes, made nutrition checklists, and tried their hand at fireless cooking. The students participated eagerly, making it a memorable day for all.</p>
                                            <div class="whiteBtn-medium">
                                                <a href="#">View Gallery</a>
                                            </div>
                                        </div>
                            ...
                            <div class="splide__track">
                                <ul class="splide__list">
                                    ...
                                    <li class="splide__slide">
                                        ...
                                        <div class="thumbContent">
                                            <h6>5th June 2024</h6>
                                            <p>The Correspondents, Mrs. Krithika Kumar Quintal and Mrs. Tamara Ann Coelho, inaugurated the newly renovated staff rooms in a formal ceremony. This renovation reflects a commitment to creating a comfortable and productive environment for the teaching staff.</p>
                                            <div class="whiteBtn-medium">
                                                <a href="#">View Gallery</a>
                                            </div>
                                        </div>
                                    ...
                                    <li class="splide__slide">
                                     ...
                                     <li class="splide__slide">
                                        ...
                                        <div class="thumbContent">
                                            ...
                                            <p>International Yoga Day was observed during the school assembly. Students demonstrated various yoga asanas, showcasing their flexibility and discipline. The event emphasised the importance of yoga in promoting physical and mental well-being, creating a reflective and enlightening experience for all the participants.</p>
                                            <div class="whiteBtn-medium">
                                                <a href="#">View Gallery</a>
                                            </div>
                                        </div>
                                     ...
                                     <li class="splide__slide">
                                        ...
                                        <div class="thumbContent">
                                            ...
                                            <p>A storytelling session was conducted by Mrs. Shalini for students of LKG, UKG, and Classes I to III, featuring the story Superheroes Are Everywhere by Kamala Harris. Mrs. Shalini’s lively narration captivated the children, making it a delightful and engaging experience for all the young participants.</p>
                                            <div class="whiteBtn-medium">
                                                <a href="#">View Gallery</a>
                                            </div>
                                        </div>
                                    ...
                                    <li class="splide__slide">
                                      ...
                                      <li class="splide__slide">
                                        ...
                                        <div class="thumbContent">
                                            ...
                                            <p>The Literary Club’s activity for the year revolved around the theme The Caricature Convention. This vibrant event brought together students from Classes UKG to X and Class XII, offering them a unique platform to showcase their creativity and artistic expression. Activities included a puppet show, story writing, and dressing up as beloved comic characters. The event was a delightful blend of fun and learning, leaving participants enriched and inspired.</p>
                                            <div class="whiteBtn-medium">
                                                <a href="#">View Gallery</a>
                                            </div>
                                        </div>
