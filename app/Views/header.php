                    ...
                    <ul class="navbar-nav">
                        <li id="aboutMenu" class="nav-item">
                            ...
                            <span class="dropdown-arrow">
                                <img src="<?= base_url('images/menuDownArrow.svg') ?>" class="img-fluid"
                                    alt="menu arrow">
                            </span>
                            <ul class="dropdown-menu">
                                ...
                                <li><a target="_blank" href="https://themadrassevasadan.org/Be_A_Part">Be a Part</a>
                                </li>
                            </ul>
                        </li>
                        <li id="academicsMenu" class="nav-item">
                            <a class="nav-link" href="<?= base_url('academics') ?>">Academics</a>
                            <span class="dropdown-arrow"><img src="<?= base_url('images/menuDownArrow.svg') ?>"
                                    class="img-fluid" alt="menu arrow"></span>
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?= base_url('academics#annual-pedagogical') ?>">Annual Pedagogical
                                        Policy</a></li>
                            </ul>
                        </li>
                        <li id="facilitiesMenu" class="nav-item">
                            ...
                            <span class="dropdown-arrow"><img src="<?= base_url('images/menuDownArrow.svg') ?>"
                                    class="img-fluid" alt="menu arrow"></span>
                            <ul class="dropdown-menu">
                                <li><a href="<?= base_url('facilities#academicfacility') ?>" class="active">Academic
                                        Facilities</a></li>
                        ...
                        <li id="admissionMenu" class="nav-item">
                            ...
                            <span class="dropdown-arrow"><img src="<?= base_url('images/menuDownArrow.svg') ?>"
                                    class="img-fluid" alt="menu arrow"></span>
                            <ul class="dropdown-menu">
                                <li><a href="<?= base_url('admission#application_process') ?>"
                                        class="active">Application Process</a></li>
                                ...
                                <li><a href="<?= base_url('admission#registration_process') ?>">Registration Process</a>
                                </li>
                            </ul>
                        </li>
                        <li id="inclusiveMenu" class="nav-item">
                            ...
                            <span class="dropdown-arrow"><img src="<?= base_url('images/menuDownArrow.svg') ?>"
                                    class="img-fluid" alt="menu arrow"></span>
                            <ul class="dropdown-menu">
                                <li><a href="<?= base_url('inclusive-education#learing_center') ?>"
                                        class="active">Learning Centre</a></li>
                                <li><a href="<?= base_url('inclusive-education#Occupational') ?>">Occupational
                                        Therapy</a></li>
                            </ul>
                        </li>
                        <li id="curriculumMenu" class="nav-item">
                            ...
                            <span class="dropdown-arrow"><img src="<?= base_url('images/menuDownArrow.svg') ?>"
                                    class="img-fluid" alt="menu arrow"></span>
                            <ul class="dropdown-menu">
                                <li><a href="<?= base_url('beyond-curriculum#sirMutha-clubs') ?>"
                                        class="active">Clubs</a></li>
                                <li><a href="<?= base_url('beyond-curriculum#news-letter') ?>">Student's Newsletters</a>
                                </li>
                ...
                <div class="subMenus col-12 col-md-5 col-lg-5 col-xl-4">
                    ...
                    <div id="academicsSubMenu" class="subMenuItems">
                        <ul>
                            ...
                            <li><a href="<?= base_url('academics#cbsecurriculum') ?>">CBSE Curriculum</a></li>
                            <li><a href="<?= base_url('academics#teacherenrichment') ?>">Teacher Enrichment</a></li>
                            <li><a href="<?= base_url('academics#annual-pedagogical') ?>">Annul Pedegogical Policy</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div id="inclusiveSubMenu" class="subMenuItems">
                        <ul>
                            ...
                            <li><a href="<?= base_url('inclusive-education#Occupational') ?>">Occupational Therapy</a>
                            </li>
                        </ul>
                    </div>
