...
<main>
                ...
                <div class="row">
                    ...
                    <div class="formFields row w100 m-0">
                        ...
                        <div class="col-12 col-md-6 col-lg-6 fields">
                            ...
                            <input type="date" id="dob" name="dob" min="2001-04-01" max="2021-04-01"
                                class="form-control"
                                value="<?php echo isset($oldInput['dob']) ? $oldInput['dob'] : ''; ?>">
                            <span>(The child should complete 4 yrs of age as on 1st April 2025 for LKG)</span>
                        </div>
                    </div>
                    ...
                    <div class="formFields row w100 m-0">
                        ...
                        <div class="col-12 col-md-6 col-lg-6 fields">
                            ...
                            <input type="text" id="nationality" name="nationality" class="form-control"
                                ...
                                value="<?php echo isset($oldInput['nationality']) ? $oldInput['nationality'] : ''; ?>">
                        </div>
                    </div>
                    ...
                    <div class="formFields row w100 m-0">
                        ...
                        <div class="col-12 col-md-6 col-lg-6 fields">
                            ...
                            <input id="class_last_studied" type="text" name="class_last_studied" class="form-control"
                                placeholder="Enter last studied class"
                                value="<?php echo isset($oldInput['class_last_studied']) ? $oldInput['class_last_studied'] : ''; ?>">
                        </div>
                    </div>
                    <div class="formFields row w100 m-0">
                        ...
                        <div class="col-12 col-md-6 col-lg-6 fields">
                            ...
                            <input id="school_last_attended" type="text" name="school_last_attended"
                                class="form-control" placeholder="Enter last attended school"
                                value="<?php echo isset($oldInput['school_last_attended']) ? $oldInput['school_last_attended'] : ''; ?>">
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-6 fields">
                            ...
                            <select id="class_admission_sought" name="class_admission_sought" class="form-control">
                                <option value="">Select</option>
                                <option value="EYP I (LKG)"
                                    <?php echo isset($oldInput['class_admission_sought']) && $oldInput['class_admission_sought'] === 'EYP I (LKG)' ? 'selected' : ''; ?>>
                                    EYP I (LKG)</option>
                                <option value="EYP II (UKG)"
                                    <?php echo isset($oldInput['class_admission_sought']) && $oldInput['class_admission_sought'] === 'EYP II (UKG)' ? 'selected' : ''; ?>>
                                    EYP II (UKG)</option>
                                <option value="PYP I (Class 1)"
                                    <?php echo isset($oldInput['class_admission_sought']) && $oldInput['class_admission_sought'] === 'PYP I (Class 1)' ? 'selected' : ''; ?>>
                                    PYP I (Class 1)</option>
                                <option value="PYP II (Class 2)"
                                    <?php echo isset($oldInput['class_admission_sought']) && $oldInput['class_admission_sought'] === 'PYP II (Class 2)' ? 'selected' : ''; ?>>
                                    PYP II (Class 2)</option>
                                <option value="PYP III (Class 3)"
                                    <?php echo isset($oldInput['class_admission_sought']) && $oldInput['class_admission_sought'] === 'PYP III (Class 3)' ? 'selected' : ''; ?>>
                                    PYP III (Class 3)</option>
                                <option value="PYP IV (Class 4)"
                                    <?php echo isset($oldInput['class_admission_sought']) && $oldInput['class_admission_sought'] === 'PYP IV (Class 4)' ? 'selected' : ''; ?>>
                                    PYP IV (Class 4)</option>
                                <option value="PYP V (Class 5)"
                                    <?php echo isset($oldInput['class_admission_sought']) && $oldInput['class_admission_sought'] === 'PYP V (Class 5)' ? 'selected' : ''; ?>>
                                    PYP V (Class 5)</option>
                                <option value="MYP I (Class 6)"
                                    <?php echo isset($oldInput['class_admission_sought']) && $oldInput['class_admission_sought'] === 'MYP I (Class 6)' ? 'selected' : ''; ?>>
                                    MYP I (Class 6)</option>
                                <option value="MYP II (Class 7)"
                                    <?php echo isset($oldInput['class_admission_sought']) && $oldInput['class_admission_sought'] === 'MYP II (Class 7)' ? 'selected' : ''; ?>>
                                    MYP II (Class 7)</option>
                                <option value="MYP III (Class 8)"
                                    <?php echo isset($oldInput['class_admission_sought']) && $oldInput['class_admission_sought'] === 'MYP III (Class 8)' ? 'selected' : ''; ?>>
                                    MYP III (Class 8)</option>
                                <option value="MYP IV (Class 9)"
                                    <?php echo isset($oldInput['class_admission_sought']) && $oldInput['class_admission_sought'] === 'MYP IV (Class 9)' ? 'selected' : ''; ?>>
                                    MYP IV (Class 9)</option>
                            </select>
                        </div>
                    </div>
                    <div class="formFields row w100 m-0">
    ...
    <script>
        ...
        $('#father_email, #mother_email, #guardian_email').on("input", function() {
            const value = $(this).val();
            $(this).val(value.replace(/[^a-zA-Z0-9._-@]/g, "")); // Allow only valid email characters
        });
    </script>
    <script>
