...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            .btn { display: none; } /* Hide button in print view */
        }
        
        .note {
            display: none; /* Hide by default, only visible during print */
        }
    </style>
</head>
<body>
    <div class="container">
        ...
        <?php if (isset($admissions)): ?>
            ...
            <div class="note">
                Note: A copy of this completed Registration Form with Signature must be submitted to Mrs. Swarnalatha, +91 73586 00554, at the time of the Interview.
            </div>
        <?php else: ?>
